...
namespace modules\alpinedigital\console\controllers;
...
class SetupController extends Controller
{
    ...
    .______.   .__.    _______...__...________.   ___      .__.
    |  ___  \  |  |   /  _____| |  | |__   .__|  /   \     |  |
    |  |  |  | |  |  /  / .___. |  |    |  |    /  ^  \    |  |
    |  |  |  | |  | |  | |__  | |  |    |  |   /  /_\  \   |  | 
    |  |__|  | |  |  \  \___| | |  |    |  |  /  _____  \  |  |____.
...
EOD;
        ...
        $this->stdout(str_replace("\n", PHP_EOL, $alpineDigital), Console::FG_BLUE);
