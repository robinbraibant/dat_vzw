...
return [
    ...
    'dev' => [
        ...
        'imageProcessors' => [
            // jpeg optimizers
            'jpegoptim' => [
                'commandPath' => '/opt/homebrew/Cellar/jpegoptim/1.5.3/bin/jpegoptim',
                'commandOptions' => '-s',
                'commandOutputFileFlag' => '',
            ],
            // png optimizers
            'optipng' => [
                'commandPath' => '/opt/homebrew/Cellar/optipng/0.7.7/bin/optipng',
                'commandOptions' => '-o3 -strip all',
                'commandOutputFileFlag' => '',
            ],
        ...
        'imageVariantCreators' => [
            // webp variant creator
            'cwebp' => [
                'commandPath' => '/opt/homebrew/Cellar/webp/1.3.0_1/bin/cwebp',
                'commandOptions' => '-jpeg_like -af',
                'commandOutputFileFlag' => '-o',
                'commandQualityFlag' => '-q',
                'imageVariantExtension' => 'webp',
